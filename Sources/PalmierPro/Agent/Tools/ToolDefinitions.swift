...
enum ToolDefinitions {
    static let all: [AgentTool] = [
        ...
        AgentTool(
            name: .addCaptions,
            description: "Transcribes spoken audio and creates styled caption text clips. Omit clipIds by default; this captions the timeline's main spoken track and is the right path for ordinary requests like captioning the timeline, edit, video, or track. The app uses cloud for paid users with credits, otherwise local. Cloud auto-detects language. Only pass clipIds when the user explicitly asks to caption one specific clip, selected clips, or a narrow subset. Per-word animations are timed from transcript.",
            inputSchema: objectSchema(
                properties: mergedProperties([
